var end = {
    ...
    create : function(){
		...
		let Result = end.add.bitmapText(end.world.width-450, 150,'font', 'Result :', 56);
		...
		let iteration = 0;
		    ...
		    if(iteration < indication.length){
				let txt = end.add.bitmapText(end.world.width-450+Result.width/2,posY+=40,'font',indication[iteration++],30);
